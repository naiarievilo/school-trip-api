...
public class SnakeCaseValidationProblemDetailsConverter : JsonConverter<ValidationProblemDetails>
{
    ...
    public override void Write(Utf8JsonWriter writer, ValidationProblemDetails value, JsonSerializerOptions options)
    {
        ...
        {
            var camelCaseKey = JsonNamingPolicy.SnakeCaseLower.ConvertName(error.Key);
